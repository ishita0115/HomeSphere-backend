from .views import SendPasswordResetEmailView, UserChangePasswordView, UserPasswordResetView, registerview,UserLoginView,UserDetailView,UserProfileView,ContactMessageList,UserListView
